...
document.writeln("				<span>Email：1501558528@qq.com</span>");
document.writeln("				<span>简书ID：一封情书写给JAVA</span>");
document.writeln("				<span>个人微信号：TnT960909</span>");
...
document.writeln("					Copyright @ yfqsxgj,Design wmyskxz,2019-20xx");
document.writeln("				</div>");
document.writeln("			</div>");
